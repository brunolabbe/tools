...
| Done when                                                                                      | Proof                                                                                                                                                                                                           |
| ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. fetch→detach→farm→build→measure, single reading order, cannot build before checkout         | `ticket-reviewer.md:20-31` "Set up in this order, and **all of it before any test or check**" — verified by reading; single ordered list under one heading                                                      |
...
| 3. both existing warnings survive the move, attached to their steps                            | `ticket-reviewer.md:38-51` "Neither half fails loudly, and both fail into the same shape" — verified by reading; merged into one sequence per Build step 2's own instruction                                    |
