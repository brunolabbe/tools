...
| #   | Done when                                                                                            | Test                                                                                                                                                        |
| --- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `hard` maps to `opus`, and the file says why                                                         | `.claude/agents/builder.md@fdafd1a:25 "Pinned rather than inherited"`, and the paragraph at `:39` "names a model because `inherit` cannot keep its promise" |
