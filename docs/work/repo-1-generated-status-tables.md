...
| 4   | **low** · The acceptance table cites the `test(` line, not the assertion — the style `.claude/skills/review-ticket/SKILL.md:239-244` "Cite the line of the assertion, not the line of the" rules out                                                                                                                                      | **Declined** — every row is truthful and the citations resolve; recorded because this table is now the repo's worked example and the next one should cite the assertion                                                                       |
