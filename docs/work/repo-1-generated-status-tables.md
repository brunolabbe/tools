...
| #   | Finding                                                                                                                                                                                   | Disposition                                                                                                                                                                                                                 |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **med** · `.env.example:58` said the proxy's policy is "the only thing" that bounds egress — false, and self-contradicted two lines later                                                 | **Fixed** — five words deleted. `ssrf.ts:223` "if (!(ALLOWED_SCHEMES as readonly" and `:243` "if (net.isIP(literal) !== 0) {" do bound it in proxy mode                                                                     |
