...
| 2   | `docs/02-DEPLOYMENT.md:351` "The scope of that, and the shared store" still cited the page for the limiter's scope | **Fixed** — consequence inline, links `dl-6`'s Log                                                |
