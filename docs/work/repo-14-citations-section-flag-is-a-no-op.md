...
| Done when                                                                                                                                                  | Proof                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. `--nonsense` exits non-zero with the usage string, CLI test alongside existing spawnSync one                                                            | proven — `scripts/test/citations.test.ts:186` "the CLI rejects an unknown flag with the usage string and a" (assertions :192-196)                                                                                                                                                                                                           |
| 2. `--rev <sha> <ticket>` resolves the ticket, not a file named after the sha                                                                              | proven — `scripts/test/citations.test.ts:208` "the CLI resolves the ticket rather than a file named after" (assertions :218-222, both argument orders)                                                                                                                                                                                      |
| 3. Docblock usage line, `main()` usage string and parsed flags name the same set; a filtered run reports a strictly smaller count on a two-section fixture | proven — count clause at `scripts/test/citations.test.ts:488` "--section narrows the check to one heading's span" (assertions :492-493, 499-501, 504-506, 510); naming-agreement clause at `scripts/test/citations.test.ts:797` "the docblock usage line, USAGE, and FLAGS name the same set" (assertions :802-803), added during this gate |
