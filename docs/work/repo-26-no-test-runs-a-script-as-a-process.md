...
| --------------------------------------------------------------------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 — a process-level test asserting a non-zero exit on input it must reject  | proven                      | `scripts/test/commit-message.test.ts:304` "run as a process, a bad message is rejected", `run as a process, a bad message is rejected`                                                                                                                                                                                                                                                                                                                    |
| 2 — replacing the guard with `if (false)` fails at least one test           | **verified, independently** | The gate mutated `scripts/commit-message.mjs:317` "if (process.argv[1] !== undefined && import.meta.url ===" itself and got `1 failed \| 26 passed (27)`, failing exactly that test with `expected '' to contain 'not a conventional commit'` — an exact match to the builder's claim, assertion text included. Restored, `git status --porcelain` empty, back to `27 passed`. This is the line that had never been measured outside repo-22's own branch |
| 3 — no test asserts only the accepting direction for a silent-failure guard | proven                      | `scripts/test/commit-message.test.ts:312` "run as a process, a good message is accepted" is the accepting half, labelled weak in a comment in the file, and paired with `:304` "run as a process, a bad message is rejected"                                                                                                                                                                                                                              |
