...
the branch tip. (repo-39, 2026-09-12: repointed to where the same tests stand today, each anchored on its test's name; the handful whose tests were later replaced, or that quote a stale coordinate as the thing being corrected, are left as written and listed in the Log. repo-44, 2026-09-13: those eight are now pinned per citation to `4fcd133`, the commit that merged this record, where each still names what its row claims.)

| Acceptance line                                                       | Proven by                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Every component in `web/src/components/` rendered at least once       | `ProgressBar` `progress-bar.test.tsx:40 "a null total renders an indeterminate bar, and never a figure"` · `JobCard` `job-card.test.tsx:170 "an unknown total says so, and shows no percentage anywhere"` · `JobList` `job-card.test.tsx:615 "an empty job list renders nothing at all"` · `VariantTable` `variant-table.test.tsx:56 "renditions are listed best-first however they arrive"` · `ProbePanel` `probe-panel.test.tsx:99 "the panel opens on the variant"` · `ErrorPanel` `error-panel.test.tsx:60 "DRM is presented as an answer, with no retry to press"` · `UrlForm` `url-form.test.tsx:52 "an empty field cannot be submitted"` · `AnalysingPanel` `chrome.test.tsx:59 "a probe in flight shows an indeterminate bar and never a percentage"` · `ScenarioHints` `chrome.test.tsx:239 "the demo list offers every scenario plus the happy path"` · `ThemeToggle` `chrome.test.tsx:266 "the theme switch offers every choice and marks whichever is current"` · `App` `downloader/web/test/app.test.tsx:130 "a mocked build admits it, and offers the scenarios that reach every branch"` |
| Step 4 — `ProgressBar`/`JobCard` with `total: null`                   | `progress-bar.test.tsx:40 "a null total renders an indeterminate bar, and never a figure"`, `job-card.test.tsx:170 "an unknown total says so, and shows no percentage anywhere"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Step 4 — `JobCard` across the statuses, terminal ones included        | `job-card.test.tsx:245 "each active status names itself and says why the job is sitting there"` (active four), `job-card.test.tsx:274 "a terminal job offers nothing to cancel and no pipeline to watch"` (all three terminal)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Step 4 — the `downloading → probing` back edge (dl-9)                 | `job-card.test.tsx:288 "the downloading → probing back edge keeps the work, and is not an error"`; today's step-list defect pinned separately at `job-card.test.tsx@4fcd133:260` "CHARACTERIZATION (dl-18): the step list walks backwards on"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Step 4 — `VariantTable` selection changes                             | `variant-table.test.tsx:241 "choosing another rendition reports its id upward"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Step 4 — `VariantTable` audio-only rendition                          | `variant-table.test.tsx:77 "an audio-only rendition says so rather than reporting a resolution"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Step 4 — `VariantTable` variant with no resolution                    | `variant-table.test.tsx@4fcd133:162` "a variant with no resolution renders the unknown marker"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Step 4 — default selection matching `lib/variants.ts`                 | `variant-table.test.tsx:249 "the default selection is the one"`, and the panel actually opening there at `probe-panel.test.tsx:99 "the panel opens on the variant"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Step 4 — `ErrorPanel` retryable with `retryAfterSec`                  | `error-panel.test.tsx:76 "a retryable rate limit offers the retry, and says when"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Step 4 — `ErrorPanel` `DRM_PROTECTED`                                 | `error-panel.test.tsx:60 "DRM is presented as an answer, with no retry to press"`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Step 4 — `UrlForm` submit disabled on empty                           | `url-form.test.tsx:52 "an empty field cannot be submitted"`. **Partial by design:** an _invalid_ URL does not disable submit, and should not — `url-form.test.tsx:137 "the field's own type refuses a string that is not a URL at all"` pins the native `type="url"` guard that stops it instead. See the first Log entry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Step 4 — `sourceUrlSchema` rejection surfacing, not swallowed         | `url-form.test.tsx:119 "a scheme the contract refuses still reaches the parent"` (reaches the parent), `downloader/web/test/app.test.tsx:274 "an address the contract refuses is rejected here, without a request"` (becomes an `INVALID_URL` panel)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Step 4 — `App`'s `USING_MOCK_API` banner                              | `downloader/web/test/app.test.tsx:130 "a mocked build admits it, and offers the scenarios that reach every branch"` (present when mocked), `downloader/web/test/app.test.tsx:140 "a real build carries no mention of a mock anywhere on the page"` (absent when not)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Step 4 — `App`'s `probeToken` race                                    | **Both arms, since gate 4.** Resolve: `downloader/web/test/app.test.tsx:153 "a late response from an abandoned analysis never overwrites the current one"`, and the abandon path at `:250 "abandoning the wait also abandons the response that follows it"`. Reject — the likelier arm, and unproven until gate 4: `downloader/web/test/app.test.tsx:188 "from an abandoned analysis is dropped too"`, and the abandon path at `:227 "a rejection that arrives after the wait was abandoned raises nothing"`. Deleting either guard alone now reddens 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| A test fails if a `null` total renders determinate or as `0%`         | `progress-bar.test.tsx:40 "a null total renders an indeterminate bar, and never a figure"`, `job-card.test.tsx:170 "an unknown total says so, and shows no percentage anywhere"`, `chrome.test.tsx:59 "a probe in flight shows an indeterminate bar and never a percentage"` — watched failing: an unconditional `value` on `ProgressBar` reddens 4 across 3 files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| 9   | low | `App`'s `startError`/`retryJob` shell paths uncovered; the jsdom native-validation assertion is environment-dependent                                                                                  | **accepted, and unmarked in the code** — the only trace of the uncovered paths is the string "not exercised by this suite" in `downloader/web/test/app.test.tsx`'s fake client, which names neither. The jsdom assertion _is_ commented, at `url-form.test.tsx:137 "the field's own type refuses a string that is not a URL at all"`. Recorded here instead |
...
| #   | Sev  | Finding                                                                                                                                                                                                                                       | Disposition                                                                                                                                                                                                                                                   |
| --- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | med  | Sixth blind assertion: `JobList.tsx`'s `streamState={streamStates[job.id]}` proven by nothing — the fixture said `{ "job-1": "open" }`, and `"open"` is the one value that renders nothing, so `streamState={undefined}` passed all 154 tests | **fixed** — `job-card.test.tsx:655 "each card is handed its own stream state, looked up by job id"` uses `{ "job-2": "reconnecting" }` and asserts the pill in the second card and absent from the first; `undefined` and an index-keyed lookup each redden 1 |
| 2   | low  | Same shape at `ProbePanel.tsx`'s `cached` badge — only the true branch asserted                                                                                                                                                               | **fixed** — `probe-panel.test.tsx:167 "a fresh probe is not labelled cached"`                                                                                                                                                                                 |
| 3   | low  | Same shape at `VariantTable.tsx`'s `row.hasVideo && row.fps !== "—"` guard                                                                                                                                                                    | **fixed** — `variant-table.test.tsx:98 "a video rendition shows its frame rate beside the resolution"` and `:109 "a video rendition with no frame rate shows the resolution alone"`, both directions                                                          |
| 4   | low  | `retryable` and `retryAfterSec` gated on different expressions, so a `RATE_LIMITED` the server marked `retryable: false` still rendered a wait                                                                                                | **fixed** — one `retryable` const now gates both; `error-panel.test.tsx:156 "a retry the server itself withdrew takes its wait with it"` pins the combination                                                                                                 |
...
- `VariantTable.tsx`'s `row.hasAudio ? row.audioCodec : "none"` — every fixture
  ...
  different claim from "this has no sound". Fixed at `variant-table.test.tsx:121 "a silent rendition says 'none', not the unknown marker"`.
- `JobCard.tsx`'s `segmentsTotal === null` branch — collapsing it printed the
  literal string `"null"` at a user. Fixed at `job-card.test.tsx:220 "a half-known segment count shows what is done, not a count against null"`.
- `JobCard.tsx`'s `result.durationSec !== null` branch — a trailing ` · —`.
  Fixed at `job-card.test.tsx:236 "a finished file of unknown duration is described without a trailing dash"`.
...
| #   | Sev  | Finding                                                                                                                                                                                                                                                                                               | Disposition                                                                                                                                                                                                                                                       |
| --- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A   | med  | `JobCard.tsx`'s pill _value_ unproven — gate 3 proved the lookup, not the comparison. `streamState !== undefined` left 162 green, which would put a permanent "reconnecting…" pill on every healthy stream. The irony is exact: the gate-3 fix removed the only fixture that supplied a healthy value | **fixed** — `job-card.test.tsx:575 "a healthy stream shows no pill at all"` mounts all four healthy states plus `undefined`; the mutant reddens 1                                                                                                                 |
| B   | med  | `JobCard.tsx`'s `segmentsDone === null → UNKNOWN`, the twin of the branch fixed at gate 3. Collapsing it renders `Segmentsnull`, and `fixtures.ts` defaults `segmentsDone: null` so nearly every card takes it                                                                                        | **fixed** — `job-card.test.tsx:208 "an unenumerated segment count is a dash, not the word null"`; a new `stat()` helper reads a named row rather than hunting a dash anywhere on the card                                                                         |
| C   | med  | The probe race half-proven: both race tests only ever _resolved_. Deleting the `catch`-side `probeToken` guard alone left 162 green — and a slow probe is likelier to reject than to succeed late                                                                                                     | **fixed** — `downloader/web/test/app.test.tsx:188 "from an abandoned analysis is dropped too"` and `:227 "a rejection that arrives after the wait was abandoned raises nothing"`; the catch-side mutant reddens 2. Log sentence and acceptance row both corrected |
...
| G   | low  | The pipeline's `--done`/`--active` classes asserted nowhere positively; both predicates could be `false` with 162 green                                                                                                                                                                               | **fixed** — `job-card.test.tsx:313 "a forward-running job marks the steps behind it done and the current one active"` pins all five steps for a forward-running job; the mutant reddens 1                                                                         |
...
| #   | Sev  | Finding                                                                                                                                                                                                                        | Disposition                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| --- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | info | Three citations in the gate-3 subsection stale — this round's own `+66` lines moved their targets, landing two of them mid-body in other tests                                                                                 | **fixed** — `job-card.test.tsx@4fcd133:379` "permanent orange pill and the suite says nothing." → `job-card.test.tsx@4fcd133:445` "Clear 2 finished", `job-card.test.tsx@4fcd133:122` "const bar = screen.getByRole" → `job-card.test.tsx@4fcd133:145` "a half-known segment count shows what is done, not a count", `job-card.test.tsx@4fcd133:139` ", { progress: { segmentsDone: null, segmentsTotal: null }" → `job-card.test.tsx@4fcd133:161` "a finished file of unknown duration is described without a". Not a dating convention: the other gate-3 citations _were_ refreshed, so these three were an oversight |
...
- **2026-09-12 — repo-39: the `## Review` citations anchored, 57 failing references down to 8.** Every acceptance row and every gate's fix column now names its test and carries the test's name as the anchor. Most had drifted: dl-18, dl-43 and dl-45 all added tests above these in `job-card.test.tsx`, so a bare coordinate was landing mid-body in a neighbour. Each was repointed by the test that enclosed it at the commit that wrote it, never by an offset, and a note beside the acceptance table's "as of the branch tip" says so. `GRANDFATHERED` 57 → 8.

  **The 8 left failing, none of them forced.** The back-edge row's second citation names dl-15's CHARACTERIZATION test, which dl-18 replaced with its inverse, so nothing stands there. The no-resolution row's test was replaced by dl-42's, which asserts the opposite claim (named by its label, not the unknown marker), so repointing would make the row prove something it never said. And gate 5's first finding quotes six coordinates as an old → new correction transcript, which are the finding's subject rather than pointers. All eight were true of some commit and of nothing since, which is the case repo-35's per-citation pin exists for; until it lands, anchoring any of them would anchor a stale coordinate to today's content. Nothing outside `## Review` was stale.

- **2026-09-13 — repo-44: repo-39's 8 pinned, 8 failing references down to 0.** All eight stand at `4fcd133`, the commit that merged this record: the CHARACTERIZATION test, the no-resolution test, and gate 5's six-coordinate correction transcript, whose old side lands mid-body in other tests at that commit — which is the finding — and whose new side names the tests it was re-resolved to. A dated note beside the acceptance table's note says so.
