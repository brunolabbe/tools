...
the branch tip. (repo-39, 2026-09-12: repointed to where the same tests stand today, each anchored on its test's name; the handful whose tests were later replaced, or that quote a stale coordinate as the thing being corrected, are left as written and listed in the Log.)
...
| Step 4 — the `downloading → probing` back edge (dl-9)                 | `job-card.test.tsx:288 "the downloading → probing back edge keeps the work, and is not an error"`; today's step-list defect pinned separately at `job-card.test.tsx:260`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
