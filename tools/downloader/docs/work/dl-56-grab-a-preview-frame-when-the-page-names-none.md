...
| Done when                                                                                                                   | Proof                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The grab runs through the ffmpeg egress proxy with the probe's `RequestContext` replayed                                    | `downloader/api/src/server.ts@20eb8ba:408 "createFrameGrabber({"` wires `proxyUrl: ffmpegEgress.proxyUrl` (never `tierProxy`), reproduced by mutation: reverting that argument to `""` turns `api/test/frame-grab-egress.test.ts:317 "segments on a blocked address: no preview, and not one request reaches it"` red — 2 requests reach `/localhost/seg*` — then restored; positive control at `:306 "segments on an allowed address: the grab produces a frame (the control)"` ✓ |
