...
- **verified** · `ROUTES.jobs` retained correctly: `app.post(ROUTES.jobs, …)` remains at `api/src/routes/jobs.ts:37 "app.post(ROUTES.jobs"`; `app.get(ROUTES.jobs, …)` is gone. `api/test/routes.test.ts` 40/40 pass.
