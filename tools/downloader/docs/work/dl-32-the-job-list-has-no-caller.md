...
- **verified** · `docs/02-DEPLOYMENT.md` correctly untouched (`git diff origin/main...HEAD -- docs/02-DEPLOYMENT.md` empty); its "no authentication anywhere in the application" claim (`docs/02-DEPLOYMENT.md:217 "no authentication anywhere in the application"`) is unchanged and still accurate.
