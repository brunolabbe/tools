...
| Done when                                                                                                                    | Proof                                                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/api/health` reports the grounding provider by name; a test asserts no key, no endpoint                                     | `tools/planner/api/test/health.test.ts@8849c14:37` "names the grounding provider too, and says nothing else about it" ✓                                                                                                                                                                                                                 |
| Unknown `GROUNDING_PROVIDER` yields the fixture provider, beside the `MODEL_PROVIDER` case                                   | `tools/planner/api/test/config.test.ts@8849c14:47` "falls back to the fixture provider when the grounding name is unknown" ✓                                                                                                                                                                                                            |
