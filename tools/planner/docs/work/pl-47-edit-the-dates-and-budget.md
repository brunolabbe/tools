...
| Rules file and planner `CLAUDE.md` name both stored kinds                                                                                                                                                       | verified by hand — `.claude/rules/planner-unchecked-constraints.md@abeb369:62 "are the two exceptions, and they"`, `tools/planner/CLAUDE.md:154 "the other is"`, `tools/planner/CLAUDE.md:222 "It is keyed on"` ✓                                                                                                                                                                                                                                      |
