...
| Done when                                                                                                       | Proof                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A plan list and a plan detail render from real data, list not loading revisions                                 | `api/test/plan-view.test.ts:185 "lists plans without loading their revisions"` (list omits `revisions`/`candidates`/`brief`), `api/test/plan-view.test.ts:104 "comes back with the document and what nothing checked about it"` (detail) ✓                                                                                                                                                                                                                                                                      |
...
| Every plan says travel time was not checked, asserted on a plan loaded from the database, not one just composed | `api/test/plan-view.test.ts:127 "says travel time was not checked, on a plan read back from the database"` — real SQLite, over HTTP, after `runToCompletion`, read twice ✓ (strong; exactly the trap named)                                                                                                                                                                                                                                                                                                     |
