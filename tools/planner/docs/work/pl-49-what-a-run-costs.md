...
| Done when                                                                                                        | Proof                                                                                                                                                                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Migration test: fresh DB and one at the previous migration both reach the new one with the columns               | `migrations.test.ts:132 "carry a column for each token kind"` and `migrations.test.ts:141 "reads as unrecorded"` ✓                                                                                                                                            |
