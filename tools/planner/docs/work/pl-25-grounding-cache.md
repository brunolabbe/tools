...
| Done when                                                                                                                         | Proof                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Two identical lookups in one run hit the underlying provider once; by a counting fake, not by timing                              | `api/test/grounding-cache.test.ts:241` "costs one `locate` call, not two", `:252` "costs one `travel` call, not two", `:298` "a matrix it holds in full costs no call at all" ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| A cached fact's `Source.fetchedAt` is the original fetch time, with a clock that moved between write and read                     | `api/test/grounding-cache.test.ts:316` "carries the original fetch time, not the time it was served", `api/test/grounding-cache.test.ts:332` "carries the original fetch time through a `travel` cell too" ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| An expired row is not served, and is gone after eviction runs                                                                     | `api/test/grounding-cache.test.ts:350` "does not serve a row that has aged out", `api/test/grounding-cache.test.ts:393` "an expired row is gone once eviction runs", `api/test/grounding-cache.test.ts:405` "eviction leaves what is still good alone" ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| A cache hit does not decrement the run's grounding budget; a miss does                                                            | `api/test/grounding-cache.test.ts:513` "a miss spends a call and a hit does not", `api/test/grounding-cache.test.ts:528` "a matrix the table holds in full spends nothing", `api/test/grounding-cache.test.ts:600` "a hit still answers once the budget is spent" ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `constructor` / `__proto__` / `toString` miss like any other unknown question                                                     | `api/test/grounding-cache.test.ts:668` "%s misses like any other unknown place" `test.each(["constructor", "__proto__", "toString", "valueOf"])` "%s misses like any other unknown place" ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `locate` **and** `travel` share a row on case and surrounding whitespace; anything else the normaliser touches is named in a test | `api/test/grounding-cache.test.ts:704` "case and surrounding whitespace: one row, one call", `api/test/grounding-cache.test.ts:721` "the same three, on `travel`, at both ends of the leg", `api/test/grounding-cache.test.ts:734` "and one row is what that costs the table, not two"; and `api/test/grounding-cache.test.ts:715` "repeated whitespace inside a name, which a model writes", `api/test/grounding-cache.test.ts:755` "control characters, so no name can forge another pair's key", `api/test/grounding-cache.test.ts:763` "and nothing else — accents stay, because they are a", `api/test/grounding-cache.test.ts:773` "nor punctuation, nor an abbreviation anyone would expand by", `api/test/grounding-cache.test.ts:782` "a locality is part of the question, and having none is not", `api/test/grounding-cache.test.ts:791` "a travel key is ordered, because the two directions are two", `api/test/grounding-cache.test.ts:797` "and carries the mode, so a mode nobody asked for cannot" name the rest ✓ |
| Migration 5 applies to a database at `user_version = 4`; existing suites pass against a fresh one                                 | `api/test/migrations.test.ts@6ad9de2:58` "migration 5 applies to a database at user_version = 4"; `schema.test.ts` and `migrations.test.ts` moved 4→5 with insertions only ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
