...
| `RATE_LIMIT_RUNS_PER_MINUTE`  | `5`             | Runs one client may start: a draft or a re-plan. Zero disables it (pl-16, pl-44)       |
| `RATE_LIMIT_EDITS_PER_MINUTE` | `30`            | Moves, removes and restores one client may make. Zero disables it (pl-44)              |
