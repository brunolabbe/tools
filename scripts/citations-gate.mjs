...
export const GRANDFATHERED = new Map([
  ...
  ["tools/downloader/docs/work/dl-15-component-render-tests.md", 8],
  ["tools/downloader/docs/work/dl-16-e2e-through-the-sniffer.md", 3],
  ["tools/downloader/docs/work/dl-18-pipeline-high-water-mark.md", 4],
  ["tools/downloader/docs/work/dl-19-ffmpeg-verifies-tls.md", 3],
  ["tools/downloader/docs/work/dl-32-the-job-list-has-no-caller.md", 3],
  ["tools/downloader/docs/work/dl-33-tls-fixture-certificates-fail-under-contention.md", 17],
  ["tools/downloader/docs/work/dl-36-fixture-certificate-serials-are-negative.md", 2],
  ["tools/downloader/docs/work/dl-40-twenty-rows-that-differ-invisibly.md", 4],
  ["tools/downloader/docs/work/dl-41-preview-in-the-completed-result.md", 2],
  ["tools/downloader/docs/work/dl-42-direct-file-claims-audio-it-never-checked.md", 1],
  ["tools/downloader/docs/work/dl-44-persist-the-thumbnail-beside-the-file.md", 4],
  ["tools/downloader/docs/work/dl-45-keep-the-failover-mirrors.md", 2],
